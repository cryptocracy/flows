...
For Souq to fully function the path to a Preferred server needs to be saved in its configuration, this is how you setup a Preferred server for the Souq to sync up with.
